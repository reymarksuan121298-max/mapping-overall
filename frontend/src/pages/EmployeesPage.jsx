...
export default function EmployeesPage({ user }) {
        ...
        (async () => {
          ...
          while (true) {
            const { data, error } = await supabase.from('employees').select(`
              ...
              photo_url, id_photo_url, coordinate_screenshot_url, latitude, longitude, contact_number, address,
              franchises (name),
              areas (name),
  ...
  const openEditModal = (emp) => {
    ...
    setFormData({
      ...
      franchise_id: emp.franchise_id ? emp.franchise_id.toString() : '', 
      area_id: emp.area_id ? emp.area_id.toString() : '',
      supervisor_id: emp.supervisor_id ? emp.supervisor_id.toString() : '',
      contact_number: emp.contact_number || '',
      municipality_id: emp.municipality_id ? emp.municipality_id.toString() : '',
