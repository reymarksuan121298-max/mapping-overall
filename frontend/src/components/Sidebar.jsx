  ...
  return (
    <aside className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col shadow-[4px_0_24px_rgba(0,0,0,0.2)] z-20 relative">
      <div className="p-6 border-b border-slate-800/50 flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-700 flex items-center justify-center text-white shadow-[0_0_15px_rgba(16,185,129,0.3)]">
          <Activity size={20} />
        </div>
        <div>
          <h2 className="text-lg font-bold text-slate-100 tracking-wide leading-tight">KioskMap</h2>
      ...
      <div className="p-4 border-t border-slate-800/50">
        <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50 flex items-center justify-between gap-3">
          ...
          <button 
            onClick={onLogout}
            title="Sign Out"
            className="w-8 h-8 rounded-lg bg-slate-800/80 text-slate-400 hover:text-rose-400 hover:bg-rose-500/10 flex items-center justify-center transition-colors border border-transparent hover:border-rose-500/30"
          >
            <LogOut size={14} />
          </button>
        </div>
